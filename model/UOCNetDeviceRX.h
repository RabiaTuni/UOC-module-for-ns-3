...
#ifndef UOCNETDEVICERX_H_
#define UOCNETDEVICERX_H_
...
public:
	...
	ns3::UOC_ErrorModel::ModScheme GeModulationtScheme (void) const;	 // returns the modulation scheme used
...
private:
	...
	double m_RXGain;
	double m_bias;
	ns3::Ptr<ns3::UOC_ErrorModel> m_error;
